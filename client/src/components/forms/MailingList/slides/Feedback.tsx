...
import { Typography, FormGroup, FormControlLabel, Checkbox, TextField } from '@material-ui/core';
...
function Feedback({ classes, events, setEvents, feedback, setFeedback }: Props) {
        ...
        {Object.values(EVENT).map(event => (
          <FormGroup key={event}>
            <FormControlLabel
              ...
              label={<Typography color="textPrimary" variant="body1">{event}</Typography>}
            />
          </FormGroup>
        ))}
      </div>
